...
_base_ = [
    f'{mmdet_config}/_base_/models/faster_rcnn_r50_fpn.py',
    f'{mmdet_config}/_base_/datasets/coco_detection.py',
    f'{mmdet_config}/_base_/schedules/schedule_1x.py', 
    f'{mmdet_config}/_base_/default_runtime.py'
]
