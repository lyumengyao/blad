...
from acdet.datasets import build_dataloader
from acdet.utils import find_latest_checkpoint, find_prev_checkpoint, get_root_logger, patch_runner
from acdet.utils.hooks import DistEvalHook
...
def train_detector(model,
    ...
    if resume_from is not None:
        ...
        if cfg.get('load_from_prev', False):
            if osp.exists(cfg.load_from_prev):
                load_from = cfg.load_from_prev
            else:
                load_from = find_prev_checkpoint(cfg.work_dir)
