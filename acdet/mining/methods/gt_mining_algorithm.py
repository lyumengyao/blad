...
@MINERS.register_module(name='learning_loss')
class LearningLossAlgorithm(GTLossAlgorithm):    
    def value(self, loss_dict):
        return loss_dict['learning_loss']

@MINERS.register_module(name='miaod')
class MIAODAlgorithm(GTLossAlgorithm):    
    def value(self, loss_dict):
        return loss_dict['miaod']

@MINERS.register_module(name='wbqbc')
class WBQBCAlgorithm(GTLossAlgorithm):    
    def value(self, loss_dict):
        return loss_dict['wbqbc']
